...
A collection of small games and simulations built with Python and Pygame — mostly quick builds to learn game logic, pathfinding, and simulation fundamentals.
...
| [`sudoku`](./sudoku) | Sudoku, playable in pygame |
| [`tic-tac-toe-bot`](./tic-tac-toe-bot) | Tic-tac-toe playable against a simple bot opponent |
...
(Some older projects may use `main.py` instead of `main.pyw` — check the folder contents.)

## Notes

These were previously separate repos, merged here to keep the profile cleaner. Full original commit history for each project is preserved in the git log.
